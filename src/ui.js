...
export function setupUI(sim) {
    ...
    const infoData = {
        ...
        collision: { title: 'Collisions', body: '<b>Pass</b> \u2014 particles move through each other freely.<br><b>Bounce</b> \u2014 Hertz contact repulsion ($F = K\\delta^{3/2}$) with tangential friction that transfers angular momentum between spinning particles.<br><b>Merge</b> \u2014 overlapping particles combine into one, conserving total mass, charge, momentum, and angular momentum.' },
        boundary: { title: 'Boundaries', body: '<b>Despawn</b> \u2014 particles are removed when they leave the viewport.<br><b>Loop</b> \u2014 particles wrap around periodically, creating an unbounded space (opens the topology selector).<br><b>Bounce</b> \u2014 Hertz contact repulsion off walls ($F = K\\delta^{3/2}$) with friction torque from wall sliding.' },
