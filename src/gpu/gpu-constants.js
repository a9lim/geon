...
import {
    ...
    YUKAWA_COUPLING, AXION_COUPLING, HIGGS_AXION_COUPLING, HIGGS_MASS_FLOOR, EPSILON,
    PI, TWO_PI,
    BOSON_SOFTENING_SQ, BOSON_MIN_AGE, PHYSICS_DT,
    MIN_MASS, ELECTRON_MASS,
    PION_DECAY_PROB, CHARGED_PION_DECAY_PROB, BOSON_CHARGE,
    BH_THETA, BH_THETA_SQ,
    VELOCITY_VECTOR_SCALE,
    GPU_MAX_PHOTONS, GPU_MAX_PIONS, PHOTON_LIFETIME, MAX_REJECTION_SAMPLES, MAX_LEPTONS, LEPTON_LIFETIME,
    ...
    TORUS, KLEIN, RP2,
    GPU_SCALAR_GRID, GPU_SOLVE_TOLERANCE,
...
const MAX_LEPTONS: u32 = ${MAX_LEPTONS}u;
const LEPTON_LIFETIME: f32 = ${wf(LEPTON_LIFETIME)};
const PION_POOL_CAP: u32 = ${GPU_MAX_PIONS + MAX_LEPTONS}u;
...
const SOLVE_TOLERANCE: f32 = ${wf(GPU_SOLVE_TOLERANCE)};
